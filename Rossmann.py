...
class Rossmann(object):
    def __init__(self):
        ...
        self.competition_distance_scaler = pickle.load(
            open(self.home_path + 'scaler/competition_distance_scaler.pkl', 'rb'))
        self.competition_time_month_scaler = pickle.load(
            open(self.home_path + 'scaler/competition_time_month_scaler.pkl', 'rb'))
    ...
    def data_cleaning(self, df1):
        ...
        # promo_interval
        month_map = {1: 'Jan', 2: 'Fev', 3: 'Mar', 4: 'Abr', 5: 'May', 6: 'Jun', 7: 'Jul', 8: 'Ago', 9: 'Set',
